        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          <div>
            ...
            <input
              ...
              className='mt-1 block w-full px-3 py-2 text-black border border-gray-300 rounded-md shadow-sm sm:text-sm'
              value={username}
          ...
          <div>
            ...
            <input
              ...
              className='mt-1 block text-black w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm sm:text-sm'
              value={password}
          ...
          <div>
            <button
              type='submit'
              className='w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-teal-700 hover:bg-teal-800'
            >
              Submit
            </button>
          </div>
